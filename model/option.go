...
func InitOptionMap() {
	...
	inviterRewardConfig, _ := common.Marshal(common.GetInviterRewardConfig())
	common.OptionMap["InviterRewardConfig"] = string(inviterRewardConfig)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviterRewardConfig":
		...
		common.SetInviterRewardConfig(config)
