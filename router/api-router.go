...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/channel-performance", middleware.AdminAuth(), controller.GetChannelPerformance)
		...
		apiRouter.POST("/frontend/error", middleware.FrontendErrorRateLimit(), anonymousRequestBodyLimit, controller.ReportFrontendError)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/channel_preferences", controller.GetChannelPreferences)
				selfRoute.PUT("/self/channel_preferences", controller.UpdateChannelPreferences)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/channel_affinity_cache/entries", controller.ListChannelAffinityCacheEntries)
			optionRoute.PUT("/channel_affinity_cache/entries/:id", controller.UpdateChannelAffinityCacheEntry)
			optionRoute.DELETE("/channel_affinity_cache/entries/:id", controller.DeleteChannelAffinityCacheEntry)
		...
		performanceRoute.Use(middleware.RootAuth())
		{
			...
			performanceRoute.GET("/runtime-logs", controller.GetRuntimeLogs)
