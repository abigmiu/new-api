...
//     and concurrent writes surface as "database is locked".
//
...
//     readers unlocked.
//
// Overriding SQLITE_PATH replaces this DSN wholesale, so a custom path should
// keep the same `_pragma`/`_txlock` parameters.
