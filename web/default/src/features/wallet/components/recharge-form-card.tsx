        ...
        <div className='space-y-2.5 border-t pt-5 sm:pt-6'>
          ...
          {topupLink && (
            <a
              ...
              className='bg-warning hover:bg-warning/90 focus-visible:ring-warning border-warning/70 flex min-h-16 w-full items-center justify-between gap-3 rounded-lg border px-4 py-3 text-left text-base text-red-600 shadow-sm transition-colors focus-visible:ring-2 focus-visible:outline-none'
            >
              <span className='flex min-w-0 flex-col gap-0.5'>
                <span className='font-medium opacity-90'>
                  {t('Need a redemption code?')}
                </span>
                <span className='font-semibold'>{t('Get one here')}</span>
              </span>
